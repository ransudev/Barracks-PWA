...
test("staff account authorization matrix enforces route policy for create, update, lifecycle, and deactivate", () => {
  ...
  const targetCases: Array<{
    ...
    {
      label: "administrator can view but not manage another administrator",
    ...
    {
      label: "administrator may update itself but not change its own lifecycle or deactivate itself",
      actorRole: "administrator",
      targetRole: "administrator",
      desiredRole: "administrator",
      actorId: 1,
    ...
    {
      label: "administrator cannot change its own role",
      actorRole: "administrator",
      targetRole: "administrator",
      desiredRole: "manager",
      actorId: 1,
